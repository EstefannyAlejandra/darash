<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <!-- surname --> 
                <div>
                    ...
                    <select id="country_id" name="country_id" class="w-full">
        ...
        <div class="flex items-center justify-end ">
            <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800 mt-2" href="{{ route('login') }}">
