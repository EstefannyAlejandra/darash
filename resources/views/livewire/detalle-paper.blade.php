              ...
              <div class="relative flex flex-col min-h-[80vh] bg-white   text-center pt-5 items-end px-20 pb-1 ">
                ...
                <div class=" flex items-center justify-between my-2 w-[90%] mt-5 relative right-0 ">
                  ...
                  @endforeach
                    ...
                    <div class=" px-20 mb-3 w-full text-left"><span class=" block pl-1 text-blue-950 font-semibold"> Resultados de Resumen </span></div>
                    ...
                    <div class="w-[90%] mb-3 mt-3  text-red-800 font-bold text-lg">Subir Documento</div>
                    <div class="w-full min:h-9 h-auto flex items-start mb-3 text-sm ">
        ...
        <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
          <script>
                    ...
                    position: 'top-end',
                    icon: 'success',
                    title: 'Se subio correctamente el documento',
